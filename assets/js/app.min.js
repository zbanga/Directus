...
define('typetools',['moment'], function(moment) {
...
define('core-ui/textinput',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/directus_columns',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/instructions',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/checkbox',['app','backbone'], function(app, Backbone) {
...
define('core-ui/color',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/numeric',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/slider',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/single_file',['app', 'backbone', 'core/table/table.view', 'core/overlays/overlays'], function(app, Backbone, TableView, Overlays) {
...
define('core-ui/slug',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/textarea',['app', 'backbone'],function(app, Backbone) {
...
define('core-ui/directus_user',['app','backbone'], function(app, Backbone) {
...
define('core-ui/directus_activity',['app','backbone'], function(app, Backbone) {
...
define('core/UIView',['require','exports','module','backbone','plugins/backbone.layoutmanager'],function(require, exports, module) {
...
define('core-ui/datetime',['app', 'backbone', 'moment', 'core/UIView'], function(app, Backbone, moment, UIView) {
...
define('core-ui/date',['app', 'backbone', 'moment', 'core/UIView'], function(app, Backbone, moment, UIView) {
...
define('core-ui/time',['app', 'backbone', 'moment'], function(app, Backbone, moment) {
...
define('core-ui/directus_user_activity',['app','backbone', 'moment'], function(app, Backbone, moment) {
...
define('core-ui/directus_user_avatar',['app','backbone'], function(app, Backbone) {
...
define('core-ui/directus_file_size',['app','backbone'], function(app, Backbone) {
...
define('core-ui/blob',['app','backbone'], function(app, Backbone) {
...
define('core-ui/alias',['app','backbone'], function(app, Backbone) {
...
define('core-ui/salt',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/select',['app', 'backbone'],function(app, Backbone) {
...
define('core-ui/tags',['app','backbone'], function(app, Backbone) {
...
define('core-ui/many_to_one',['app', 'backbone', 'core/UIView'], function(app, Backbone, UIView) {
...
define('core-ui/radiobuttons',['app', 'backbone'], function(app, Backbone) {
...
define('schema/UIModel',['require','exports','module','backbone'],function(require, exports, module) {
...
define('schema/fixed/settings.global',['require','exports','module'],function(require, exports, module) {
  ...
  settingsGlobalSchema.structure = [
      {id: 'site_name', ui: 'textinput', char_length: 50, options: {placeholder_text: "My Project"}, comment: "The name of your project appears in the browser title"},
      {id: 'site_url', ui: 'textinput', char_length: 255, options: {placeholder_text: "http://"}, comment: "Clicking the main logo takes you to this URL"},
...
define('schema/fixed/settings.files',['require','exports','module'],function(require, exports, module) {
...
define('schema/SchemaManager',['require','exports','module','./ColumnModel','./ColumnsCollection','./TableModel','./UIModel','core/collection','core/PreferenceModel','./fixed/activity','./fixed/groups','./fixed/files','./fixed/messages','./fixed/users','./fixed/settings.global','./fixed/settings.files'],function(require, exports, module) {
...
define('core-ui/one_to_many',['app', 'backbone', 'core/table/table.view', 'schema/SchemaManager', 'core/UIView'], function(app, Backbone, TableView, SchemaManager, UIView) {
...
define('core-ui/many_to_many',['app', 'backbone', 'core-ui/one_to_many', 'core/table/table.view', 'core/overlays/overlays'], function(app, Backbone, Onetomany, TableView, Overlays) {
...
define('core-ui/wysiwyg',['app', 'backbone', 'core/overlays/overlays'], function(app, Backbone, Overlays) {
...
define('core-ui/directus_messages_recipients',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/password',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/many_to_one_typeahead',['app', 'backbone', 'core/UIView', 'utils'], function(app, Backbone, UIView, Utils) {
...
define('core-ui/enum',['app', 'backbone'],function(app, Backbone) {
...
define('core-ui/multi_select',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/system',['app','backbone'], function(app, Backbone) {
...
define('core-ui/user',['app','backbone'], function(app, Backbone) {
...
define('core-ui/directus_file',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/directus_file_title',['app', 'backbone'], function(app, Backbone) {
...
define('core-ui/map',['app', 'backbone', 'moment'], function(app, Backbone, moment) {
...
define('core-ui/multiple_files',['app', 'backbone', 'sortable', 'core/UIView', 'core/overlays/overlays'], function(app, Backbone, Sortable, UIView, Overlays) {
...
define('core-ui/translation',['app','backbone'], function(app, Backbone) {
...
define('core-ui/template_chooser',['app', 'backbone'],function(app, Backbone) {
...
define("plugins/bootstrap-dropdown", ["jquery"], function(){});
...
define("plugins/typeahead", ["jquery"], function(){});

define('app',['require','exports','module','handlebars','typetools','helpers','plugins/backbone.layoutmanager','plugins/bootstrap-dropdown','plugins/typeahead'],function(require, exports, module) {
...
define('core/entries/EntriesJunctionCollection',['require','exports','module','app','backbone','core/collection','core/EntriesManager','core/entries/EntriesModel','core/entries/EntriesCollection'],function(require, exports, module) {
...
define('core/entries/EntriesModel',['require','exports','module','app','backbone','core/entries/EntriesJunctionCollection','core/UIManager','schema/SchemaManager','core/entries/EntriesCollection','core/EntriesManager'],function(require, exports, module) {
...
define('core/entries/EntriesCollection',['require','exports','module','backbone','core/collection','core/entries/EntriesModel'],function(require, exports, module) {
...
define('core/edit',['require','exports','module','app','./UIManager'],function(require, exports, module) {
...
define('router',['require','exports','module','app','core/tabs','core/bookmarks','schema/SchemaManager','core/EntriesManager','core/ExtensionManager','modules/activity/activity','modules/tables/table','modules/settings/settings','modules/files/files','modules/users/users','modules/messages/messages','core/modal','moment'],function(require, exports, module) {
