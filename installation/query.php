...
$insert_privileges = "INSERT INTO `directus_privileges` (`id`, `table_name`, `permissions`, `group_id`, `status_id`, `allowed_status`, `read_field_blacklist`, `write_field_blacklist`, `unlisted`)
VALUES
